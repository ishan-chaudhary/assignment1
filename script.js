...
window.onload = function () {
  ...
  for (let image in images) {
    ...
    spanEl1.innerText = images[image].title.substr(0,images[image].title.length/2);
    spanEl2.innerText = images[image].title.substr(images[image].title.length/2,images[image].title.length);


    // previewText.innerText = images[image].title
    previewText.appendChild(spanEl1);
    previewText.appendChild(spanEl2)
